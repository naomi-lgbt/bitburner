/**
 * Loads the developer menu.
 * @link https://steamcommunity.com/app/1812820/discussions/0/3200370144984642310/?ctp=2#c3827551537103977024
 * @param {NS} ns The NetScape module.
 */
export async function main(ns) {
  ...
  if (typeof state === "string") {
    ...
    ns.tprintf(
      "ERROR: Exploit succeeded, but got an unknown result for the type of page"
    );
  }
}
